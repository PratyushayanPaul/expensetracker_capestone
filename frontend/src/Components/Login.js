...
import loginpic from "../Components/images/login.png"
                    ...
                    <div className="login-content">
                        <div className="login-form">
                            ...
                            <div className="login_img">
                                <figure>
                                    <img src={loginpic} alt="login-img" id="login_img" />    
                                </figure>    
                                <NavLink to="/register" className="login-image-link" id="login-image-link">Create an account</NavLink>
                            </div> 
                    </div>
                </div>
            </section>
