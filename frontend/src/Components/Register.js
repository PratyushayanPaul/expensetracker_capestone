...
import registerpic from "../Components/images/register.png";
                    ...
                    <div className="registration-content">
                        <div className="registration-form">
                            ...
                            <div className="register_img">
                                <figure>
                                    <img src={registerpic} alt="register-img" id="register_img" />    
                                </figure>    
                                <NavLink to="/login" className="register-image-link" id="register-image-link">I am already registered</NavLink>
                            </div> 
                    </div>
                </div>
            </section>
